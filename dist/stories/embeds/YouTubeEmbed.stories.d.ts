...
declare const StoryComponent: ({ url, width, height, linkText, placeholderImageUrl, placeholderSpinner, placeholderSpinnerDisabled, placeholderProps, embedPlaceholder, placeholderDisabled, youTubeProps, loadingTimeout, fallbackToThumbnail, ...divProps }: import("../../components/embeds/YouTubeEmbed").YouTubeEmbedProps) => React.JSX.Element;
